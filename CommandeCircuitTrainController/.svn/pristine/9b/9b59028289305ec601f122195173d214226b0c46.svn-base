...
import upmc.train.controller.model.StrategieEntreeCircuitEtRoute;
...
public class ClientTrainFrame extends javax.swing.JFrame implements IMessageListener, IUpdate{
    ...
    public ClientTrainFrame(Controller control) {
        ...
        this.portServerField.setText("55557");
    }

    private void initComponents() {

        synoptique = new PanelSynoptiqueExtended(0);
        jScrollPane1 = new javax.swing.JScrollPane();
        textToSend = new javax.swing.JTextArea();
        sendButton = new javax.swing.JButton();
        connectButton = new javax.swing.JButton();
        jPanel1 = new javax.swing.JPanel();
        before = new javax.swing.JComboBox<Canton>();
        after = new javax.swing.JComboBox<Canton>();
        ...
        scenario = new javax.swing.JComboBox<String>();
        ...
        scenario.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "1", "2","3","4"}));
	...
	protected void startActionPerformed(ActionEvent evt) {
		...
		if (sc.equals("7"))
		{
			this.addRoadScenario7(this.decoder.getController()) ;
			strat = new StrategieEntreeCircuitEtRoute(this.decoder.getController()) ; 
		}		
		if (sc.equals("8"))
		{
			strat = new StrategieEntreeCircuitEtRoute(this.decoder.getController()) ; 
		}
		this.frame.savePositions() ; 
		if (strat == null)
	...
	private void addRoadScenario7(Controller c)
	{
		...
		r1.addPartRoad(r11);
		InfiniteLoopRoad r14 = new InfiniteLoopRoad() ;
		r14.addCanton(c.getTopography().getCantonByid(3));
		r14.addCanton(c.getTopography().getCantonByid(4));
		r14.addCanton(c.getTopography().getCantonByid(8));
		r14.addCanton(c.getTopography().getCantonByid(9));
		r14.addCanton(c.getTopography().getCantonByid(7));
		r1.addPartRoad(r14);
    ...
    private javax.swing.JComboBox<Canton> after;
    private javax.swing.JComboBox<Canton> before;
    ...
    private javax.swing.JComboBox<String> scenario;
    private javax.swing.JButton sendButton;
    private javax.swing.JButton start;
    private PanelSynoptiqueExtended synoptique;
    private javax.swing.JTextArea textToSend;
    private  FrameTrack frame ;
    ...
    private void connectButtonActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ...
        this.frame.setControl(decoder.getController()); 
	...
	private void updateCanton(Topography topo)
	{
		...
		this.frame.updateTopography(topo);
		this.frame.setVisible(true);
	}
	
	@Override
	public void updateMVC(Object o) {
		this.frame.updateMVC(this.decoder.getScenario()) ; 
		this.synoptique.updateMVC(o);
		this.frame.updateMVC(o);
		if (o != null)
		{
